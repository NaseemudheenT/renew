...
/** Stacked activity bars (completed reminders + tasks per day). */
...
function Legend({ color, label }: { color: string; label: string }) {
  return <span className="text-muted inline-flex items-center gap-1.5"><span className={`size-2.5 rounded-sm ${color}`} />{label}</span>;
}

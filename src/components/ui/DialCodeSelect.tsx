...
export function DialCodeSelect({
  ...
  return (
    <div className="relative shrink-0" ref={ref}>
      ...
      {open && (
        <div className="absolute z-50 mt-2 w-72 max-w-[80vw] overflow-hidden rounded-2xl border border-[var(--menu-border)] bg-[var(--menu-bg)] p-2 shadow-[var(--glass-shadow)] backdrop-blur-xl">

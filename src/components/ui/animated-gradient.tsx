...
/**
 * WebGL2 animated gradient (provided by the product owner). Adapted for Renew:
 * cleaned for strict lint, typed, and used only as a subtle live background
 * behind the Renew atmosphere. Renders nothing if WebGL2 is unavailable.
 */
...
export interface GradientCustomConfig {
  color1: string;
  color2: string;
  color3: string;
  rotation?: number;

...
const variants: Record<ButtonVariant, string> = {
  primary:
    "glass glass-primary !rounded-full font-semibold hover:brightness-[1.07] hover:-translate-y-[1px]",
  glass:
    "glass !rounded-full text-[var(--text-strong)] hover:brightness-[1.04] hover:-translate-y-[1px]",
  ghost:

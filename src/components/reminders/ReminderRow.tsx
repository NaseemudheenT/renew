  ...
  return (
    ...
    >
      <CompleteToggle
        ...
        onToggle={reminder.completed ? onReopen : onComplete}
        label={reminder.completed ? "Reopen reminder" : "Complete reminder"}
      />
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          ...
          {reminder.priority === "high" && !reminder.completed && (
            <span className="rounded-full bg-rose-500/15 px-2 py-0.5 text-[10px] font-medium text-rose-600 dark:text-rose-300">
              High
            </span>
          )}
        </div>
        <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs">
          ...
          {reminder.repeat !== "none" && (
            <span className="text-muted inline-flex items-center gap-1 capitalize">

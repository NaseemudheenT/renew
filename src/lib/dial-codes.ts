/**
 * International dialling codes by ISO 3166-1 alpha-2 country. Names are derived
 * per UI-language at runtime (Intl.DisplayNames) and flags from the ISO code, so
 * the phone picker is global AND localizes with the user's language.
 */
export const DIAL_CODES: Record<string, string> = {
  ...
  CO: "+57", CR: "+506", CU: "+53", CV: "+238", CW: "+599", CY: "+357", CZ: "+420",
  ...
  IL: "+972", IM: "+44", IN: "+91", IQ: "+964", IR: "+98", IS: "+354", IT: "+39",
  ...
  MD: "+373", ME: "+382", MG: "+261", MH: "+692", MK: "+389", ML: "+223", MM: "+95",
  MN: "+976", MO: "+853", MP: "+1", MQ: "+596", MR: "+222", MS: "+1", MT: "+356",
  MU: "+230", MV: "+960", MW: "+265", MX: "+52", MY: "+60", MZ: "+258", NA: "+264",
  NC: "+687", NE: "+227", NF: "+672", NG: "+234", NI: "+505", NL: "+31", NO: "+47",
  NP: "+977", NR: "+674", NU: "+683", NZ: "+64", OM: "+968", PA: "+507", PE: "+51",
  PF: "+689", PG: "+675", PH: "+63", PK: "+92", PL: "+48", PM: "+508", PR: "+1",
  PS: "+970", PT: "+351", PW: "+680", PY: "+595", QA: "+974", RE: "+262", RO: "+40",
  RS: "+381", RU: "+7", RW: "+250", SA: "+966", SB: "+677", SC: "+248", SD: "+249",
  SE: "+46", SG: "+65", SH: "+290", SI: "+386", SK: "+421", SL: "+232", SM: "+378",
...
/** Localized, A–Z-sorted dial-code options for the given UI language. */
export function dialOptions(locale: string): DialOption[] {
  ...
  return Object.keys(DIAL_CODES)
    .map((iso) => ({ iso, name: dn?.of(iso) ?? iso, dial: DIAL_CODES[iso]!, flag: flagFor(iso) }))

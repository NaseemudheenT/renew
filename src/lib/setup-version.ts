 ...
 *
 * NOTE: "pat6" (Financial-OS restyle) and "pat7" (concrete plans + free scan
 * allowance) capture no new setup data, so CURRENT_SETUP_VERSION stays at 9 and
 ...
 */
export const APP_UPDATE_NAME = "pat7";
